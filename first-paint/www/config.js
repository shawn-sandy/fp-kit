    ...
    function (hook, vm) {
      ...
      hook.beforeEach(function (html) {
        ...
        const issue = [
          ...
          `<p><a role="button" style="--bg: lightgray; --btn-rds: 99rem" href="${vm?.config?.repo}/issues/new/?title=${title}&body=${body}" target="_blank" style="--btn-rds: var(--btn-pill)">Open a github issue</a>.</p>`,
          '</div>'
        ].join('')
